...
export const Tile = memo(forwardRef((props, ref) => {
    ...
    return (React.createElement("div", Object.assign({ id: id, className: cx(fr.cx("fr-tile", enlargeLinkOrButton &&
        ...
        ((imageUrl !== undefined && imageUrl.length > 0) || pictogram !== undefined) && (React.createElement("div", { className: cx(fr.cx("fr-tile__header"), classes.header) }, imageSvg || pictogram !== undefined ? (React.createElement("div", { className: cx(fr.cx("fr-tile__pictogram"), classes.img) }, pictogram !== undefined ? (pictogram) : (React.createElement("svg", { "aria-hidden": true, className: cx(fr.cx("fr-artwork"), classes.artwork), viewBox: "0 0 80 80", width: "80px", height: "80px", xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink" }, [
            "artwork-decorative",
            "artwork-minor",
            "artwork-major"
