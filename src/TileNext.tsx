...
/** @see <https://components.react-dsfr.codegouv.studio/?path=/docs/components-tilenext--default> */
export const TileNext = memo(
    forwardRef<HTMLDivElement, TileNextProps>((props, ref) => {
        const {
            id: id_props,
            className,
            title,
            ...
            >
                <div className={cx(fr.cx("fr-tile__body"), classes.body)}>
                    <div className={cx(fr.cx("fr-tile__content"), classes.content)}>
                        ...
                        {desc && <p className={cx(fr.cx("fr-tile__desc"), classes.desc)}>{desc}</p>}
                        {detail && (
                ...
                {imageUrl !== undefined && imageUrl.length && (
                    <div className={cx(fr.cx("fr-tile__header"), classes.header)}>
                        {imageSvg ? (
                            <div className={fr.cx("fr-tile__pictogram")}>
                                <svg
                                    aria-hidden={true}
...
TileNext.displayName = symToStr({ TileNext });

export default TileNext;
