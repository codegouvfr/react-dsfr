...
import type { data_fr_theme as data_fr_theme_bin } from "../../bin/css_to_ts/cssVariable";
import type { ColorScheme as ColorScheme_bin } from "../../bin/css_to_ts/colorOptions";
