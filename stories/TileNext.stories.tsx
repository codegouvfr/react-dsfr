...
import { TileNext, type TileNextProps } from "../dist/TileNext";
import { getStoryFactory } from "./getStory";
import { sectionName } from "./sectionName";

const { meta, getStory } = getStoryFactory({
    sectionName,
    "wrappedComponent": { TileNext },
...
- [See source code](https://github.com/codegouvfr/react-dsfr/blob/main/src/TileNext.tsx)`,
    "disabledProps": ["lang"],
    ...
    "argTypes": {
        ...
        "titleAs": {
            ...
            "options": (() => {
                ...
                assert<Equals<typeof headings[number] | undefined, TileNextProps["titleAs"]>>();
                return headings;
            })()
        },
        "linkProps": {
...
const pictoUrl = "static/media/stories/assets/city-hall.svg";

const defaultProps: TileNextProps = {
