import{A as e}from"./Accordion-CkzdNN_5.js";import{g as n,l as t}from"./getStory-JVSS1Wer.js";import"./iframe-DCkbD6Ro.js";import"./preload-helper-PPVm8Dsz.js";const{meta:r,getStory:c}=n({wrappedComponent:{Accordion:e},argTypes:{label:{control:{type:"text"}},titleAs:{description:"Define the heading level of the accordion label",options:["h1","h2","h3","h4","h5","h6",void 0]},children:{control:{type:"text"}},defaultExpanded:{control:{type:"boolean"}}},description:`- [See DSFR documentation](https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/accordeon)
