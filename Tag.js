...
export const Tag = memo(forwardRef((props, ref) => {
    var _a, _b, _c;
    const { id: id_props, className: prop_className, children, title, iconId, small = false, pressed, dismissible = false, linkProps, nativeButtonProps, nativeParagraphProps, nativeSpanProps, style, onClick } = props, rest = __rest(props, ["id", "className", "children", "title", "iconId", "small", "pressed", "dismissible", "linkProps", "nativeButtonProps", "nativeParagraphProps", "nativeSpanProps", "style", "onClick"]);
    assert();
