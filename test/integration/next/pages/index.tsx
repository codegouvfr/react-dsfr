                                                        ...
                                                        <div className="fr-radio-rich__img">
                                                            ...
                                                            >
                                                                <use
                                                                    ...
                                                                    xlinkHref={`${ArtworkLightSvg.src}#artwork-decorative`}
                                                                ></use>
                                                                <use
                                                                    className="fr-artwork-minor"
                                                                    xlinkHref={`${ArtworkLightSvg.src}#artwork-minor`}
                                                                ></use>
                                                                <use
                                                                    className="fr-artwork-major"
                                                                    xlinkHref={`${ArtworkLightSvg.src}#artwork-major`}
                                                                ></use>
                                                            </svg>
                                                        </div>
                                                    </div>
                                                    <div className="fr-radio-group fr-radio-rich">
                                                        ...
                                                        <div className="fr-radio-rich__img">
                                                            ...
                                                            >
                                                                <use
                                                                    className="fr-artwork-decorative"
                                                                    xlinkHref={`${ArtworkDarkSvg.src}#artwork-decorative`}
                                                                ></use>
                                                                <use
                                                                    className="fr-artwork-minor"
                                                                    xlinkHref={`${ArtworkDarkSvg.src}#artwork-minor`}
                                                                ></use>
                                                                <use
                                                                    className="fr-artwork-major"
                                                                    xlinkHref={`${ArtworkDarkSvg.src}#artwork-major`}
                                                                ></use>
                                                            </svg>
                                                        </div>
                                                    </div>
                                                    <div className="fr-radio-group fr-radio-rich">
                                                        ...
                                                        <div className="fr-radio-rich__img">
                                                            ...
                                                            >
                                                                <use
                                                                    className="fr-artwork-decorative"
                                                                    xlinkHref={`${ArtworkSystemSvg.src}#artwork-decorative`}
                                                                ></use>
                                                                <use
                                                                    className="fr-artwork-minor"
                                                                    xlinkHref={`${ArtworkSystemSvg.src}#artwork-minor`}
                                                                ></use>
                                                                <use
                                                                    className="fr-artwork-major"
                                                                    xlinkHref={`${ArtworkSystemSvg.src}#artwork-major`}
                                                                ></use>
                                                            </svg>
                                                        </div>
                                                    </div>
