...
export const Tabs = memo(forwardRef((props, ref) => {
    ...
    return (React.createElement("div", Object.assign({ id: id, className: cx(fr.cx("fr-tabs"), className), ref: ref, style: style }, rest),
        React.createElement("ul", { className: fr.cx("fr-tabs__list"), role: "tablist", "aria-label": label, onKeyDownCapture: e => onKeyboardNavigation(e) }, tabs.map(({ label, iconId }, tabIndex) => (React.createElement("li", { key: tabIndex, role: "presentation" },
            React.createElement("button", { ref: button => (buttonRefs.current[tabIndex] = button), id: getTabId(tabIndex), type: "button", className: cx(fr.cx("fr-tabs__tab", iconId, "fr-tabs__tab--icon-left"), classes.tab), tabIndex: tabIndex === selectedTabIndex ? 0 : -1, role: "tab", "aria-selected": tabIndex === selectedTabIndex, "aria-controls": getPanelId(tabIndex), onClick: onTabClickFactory(tabIndex) }, label))))),
