...
export const SearchBar = memo(forwardRef((props, ref) => {
    const { className, label: label_props, big = false, classes = {}, style, renderInput = ({ className, id, placeholder, type }) => (React.createElement("input", { className: className, id: id, placeholder: placeholder, type: type })), onButtonClick } = props, rest = __rest(props, ["className", "label", "big", "classes", "style", "renderInput", "onButtonClick"]);
    assert();
