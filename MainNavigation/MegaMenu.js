            ...
            React.createElement("div", { className: fr.cx("fr-grid-row", "fr-grid-row-lg--gutters") },
                leader !== undefined && (React.createElement("div", { className: fr.cx("fr-col-12", "fr-col-lg-8", "fr-col-offset-lg-4--right", "fr-mb-4v") },
                    React.createElement("div", { className: cx(fr.cx("fr-mega-menu__leader"), classes.leader) },
                        ...
                        leader.link !== undefined && (React.createElement(Link, Object.assign({}, leader.link.linkProps, { className: cx(fr.cx("fr-link", "fr-icon-arrow-right-line", "fr-link--icon-right", "fr-link--align-on-content"), leader.link.linkProps.className) }), leader.link.text))))),
                categories.map(({ categoryMainLink, links }, i) => (React.createElement("div", { className: fr.cx("fr-col-12", "fr-col-lg-3"), key: i },
                    React.createElement("h5", { className: cx(fr.cx("fr-mega-menu__category"), classes.category) },
                        React.createElement(Link, Object.assign({}, categoryMainLink.linkProps, { className: cx(fr.cx("fr-nav__link"), categoryMainLink.linkProps.className) }), categoryMainLink.text)),
                    React.createElement("ul", { className: cx(fr.cx("fr-mega-menu__list"), classes.list) }, links.map(({ linkProps, text, isActive }, i) => (React.createElement("li", { key: i },
                        React.createElement(Link, Object.assign({}, linkProps, { className: cx(fr.cx("fr-nav__link"), linkProps.className) }, (!isActive ? {} : { "aria-current": "page" })), text))))))))))));
}));
