...
export const PictoWrapper = memo((_a) => {
...
export function createPicto(SvgPath, displayName) {
    const IconComponent = props => (React.createElement(PictoWrapper, Object.assign({}, props), SvgPath));
    IconComponent.displayName = displayName;
    return IconComponent;
}
//# sourceMappingURL=PictoWrapper.js.map