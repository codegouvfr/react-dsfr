            ...
            React.createElement("div", { className: fr.cx("fr-consent-banner") },
                ...
                React.createElement("ul", { className: fr.cx("fr-consent-banner__buttons", "fr-btns-group", "fr-btns-group--right", "fr-btns-group--inline-reverse", "fr-btns-group--inline-sm") },
                    React.createElement("li", null,
                        React.createElement("button", { className: fr.cx("fr-btn"), title: t("accept all - title"), onClick: async () => {
                    ...
                    React.createElement("li", null,
                        React.createElement("button", { className: fr.cx("fr-btn"), title: t("refuse all - title"), onClick: () => {
                                setIsProcessingChanges(true);
                                processConsentChanges({ "type": "denyAll" });
                                setIsProcessingChanges(false);
                            }, disabled: isProcessingChanges }, t("refuse all"))),
                    React.createElement("li", null,
                        React.createElement("button", Object.assign({ className: fr.cx("fr-btn", "fr-btn--secondary"), title: t("customize cookies - title"), disabled: isProcessingChanges }, consentModalButtonProps), t("customize")))))));
    }
